package com.apigee.apimodel.console;
  ...
  implements APIWriter
{
  ...
  public static ConsoleWriter get()
  {
    return writer;
  }
  ...
  private Map<String,Object> operationToMethodJSON(Operation operation, Logger log)
  {
    ...
    /* request */
    if(operation.getRequestHeaders() != null && operation.getRequestHeaders().size() >0)
    {
    ...
    /* response */
    if(operation.getResponseCodes() != null && operation.getResponseCodes().size() > 0)
    {
